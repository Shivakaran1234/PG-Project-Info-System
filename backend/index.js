...
const circularrouter=require('./APIs/circular-api')
const studentCircular = require('./APIs/studentCircular-api')
app.use('/student-api',student)
app.use('/teacher-api',teacher)
app.use('/project-api',project1)
app.use('/circular-api',circularrouter)
app.use('/studentCircular-api',studentCircular)
